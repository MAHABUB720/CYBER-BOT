...
var link = ["https://i.imgur.com/N9ji8CD.png"];

var callback = () => api.sendMessage({body:`╭•┄┅══𝐌𝐀𝐇𝐀𝐁𝐔𝐁-𝐑𝐀𝐇𝐌𝐀𝐍══┅┄•╮\n\nꗥ̳̳̳̳̳̳̳̳̳̳̿̿̿̿̿̿̿̿̿̿⃟ꗥꔸআসসালামু আলাইকুমꔸꗥ⃟ꗥ̳̳̳̳̳̳̳̳̳̳̿̿̿̿̿̿̿̿̿̿\n
...
১১) বক্সের কোনো মেয়ের পারমিশন ছাড়া তার ইনবকসে নক করা যাবে না, যদি মেয়েদের বিরক্ত করার কোনো কমপ্লিন আসে তাহলে তাকে গ্ৰুপ থেকে রিমুভ করা হবে ✌️✌️
...
https://www.facebook.com/www.xnxx.com.140

<------------------------------------------------------------------------->___সাথেই থাকুন🌸༅༎•─

ꗥ̳̳̳̳̳̳̳̳̳̳̿̿̿̿̿̿̿̿̿̿⃟ꗥꔸ𝘽𝙊𝙏-𝙊𝙒𝙉𝙀𝙍-𝗙𝗔𝗥𝗛𝗔𝗡-𝗜𝗦𝗟𝗔𝗠ꔸꗥ⃟ꗥ̳̳̳̳̳̳̳̳̳̳̿̿̿̿̿̿̿̿̿̿

─༅༎•🌺ধন্যবাদ সবাইকে🌸༅༎•─\n\n╰•┄┅══𝐌𝐀𝐇𝐀𝐁𝐔𝐁-𝐑𝐀𝐇𝐌𝐀𝐍══┅┄•╯`,attachment: fs.createReadStream(__dirname + "/cache/juswa.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/juswa.jpg")); 
